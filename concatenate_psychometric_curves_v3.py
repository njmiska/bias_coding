...
import sys
sys.path.append('/Users/natemiska/Documents/python/BS')
sys.path.append('/Users/natemiska/Documents/python/allen')
...
for j in range(0,np.size(eids)):
    ...
    ########################################################################################
        ...
        file_path = '/Users/natemiska/Documents/python/BS/zapit_trials.yml'
