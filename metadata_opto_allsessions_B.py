...
#potentially strong effect R cont, unclear L cont; potential effect R 50hz, need more data L 50hz
    ...
    #### L hemisphere: Likely block bias reduction, even at 0.5V
    #### R hemisphere: No obvious effect (if anything there may be an increase in block bias). Try with higher laser intensity? (prev 0.5V) - same @0.7V
    #### Bilateral: Possible reduction. No obvious QP or RT effect
